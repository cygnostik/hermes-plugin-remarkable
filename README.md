...
1. Install from the standalone repository: `hermes plugins install https://github.com/cygnostik/hermes-plugin-remarkable`, then `hermes plugins enable remarkable`. The short catalogue name `remarkable` becomes available only after the catalogue submission is reviewed and merged.
